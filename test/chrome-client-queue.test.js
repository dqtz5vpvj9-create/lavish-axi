...
test("a long transcript entry is folded, with the whole text one click away", async () => {
  ...
  assert.match(bubble.innerHTML, /class="bubble-text is-clamped"/);
